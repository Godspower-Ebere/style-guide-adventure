        ...
        <section className="py-20 md:py-24 bg-secondary">
            <div className="container mx-auto px-4 md:px-6">
                <div className="text-center max-w-2xl mx-auto mb-12">
                    ...
                    <p className="text-muted-foreground">Our curriculum is designed to take you from beginner to pro, covering the full spectrum of modern JavaScript development.</p>
                </div>
